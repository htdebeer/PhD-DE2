...
$(document).ready ->
  ff = new FlaskFiller
    id: 'flaskfiller'
    flow_rate: FLOW_RATE
    glasses: [create_glass(json_glasses, 'cocktail'), create_glass(json_glasses, 'erlenmeyer')]
    ...
    graph:
      ...
      quantities:
        ...
        height:
          name: 'height'
          label: 'hoogte van het waterpeil'
          unit: 'cm'
          step: 1

  #ff.add( create_glass(json_glasses, 'longdrink') )
