...
WGlassGrafter = class extends Widget
  ...
  constructor: (@paper, @x, @y, @width, @height, mm_per_pixel, properties) ->
    @prop = @initialize_properties(properties)
    @PADDING = 3
    ...
    @contour = new ContourLine @CANVAS_MID, @CANVAS_TOP, @BORDER_WIDTH, @CANVAS_HEIGHT, mm_per_pixel
