...
(function() {
  ...
  make_graph = function(conf) {
    var CONTAINER_DIMENSIONS, GRAPH_DIMENSIONS, MARGINS, X_QUANTITY, Y_QUANTITY, Z_QUANTITY, all_graphs, draw_chart, draw_graph, draw_tangents, graph, id, svg_graph, toggle_chart, toggle_graph, toggle_tangents, x_axis, x_extent, x_scale, y_axis, y_extent, y_scale, _ref;
    ...
    draw_graph = function(graph, id) {
      ...
      g.append('path').attr('d', line(graph.data)).attr('class', 'graph').attr('fill', 'none').attr('stroke', graph.color);
    ...
    draw_tangents = function(graph, id) {
      ...
      g = d3.select('#graph_container').append('g').attr('id', "" + id + "-tangents").attr('class', id);
      return g.append('path').attr('d', line(graph.data)).attr('fill', 'none').attr('stroke', 'white').attr('stroke-opacity', 0).attr('stroke-width', 7).on('mouseover', function(d, i) {
