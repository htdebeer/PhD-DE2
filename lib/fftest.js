...
/*
//@ sourceMappingURL=flaskfiller.map
*/
...
(function() {
  ...
  Grapher = (function() {
    ...
    Grapher.prototype.compute_scales = function() {
      var glass, xaxis, xraster, yaxis, yraster,
        _this = this;
    ...
    Grapher.prototype.draw_graph = function(glass, id) {
      ...
      return g.append('path').attr('d', line(glass.graph.data)).attr('class', 'graph').attr('fill', 'none').attr('stroke', glass.color).style('stroke-wdith', 3);
    };
    ...
    Grapher.prototype.draw_chart = function(glass, id) {
      ...
      return g.selectAll('rect-bar').data(glass.graph.data).enter().append('rect').attr('x', function(d) {
        return _this.x_scale(d[_this.X_QUANTITY.name]);
      }).attr('y', function(d) {
        return _this.y_scale(d[_this.Y_QUANTITY.name]);
...
(function() {
  ...
  GlassTable = (function() {
    ...
    GlassTable.prototype.add_row = function(glass) {
      ...
      row.append('td').append('button').classed('btn', true).append('i').attr('id', "" + glass.name + "-fill").classed('icon-play', true).on('click', this.filling(glass));
      row.append('td').append('button').classed('btn', true).append('i').attr('id', "" + glass.name + "-empty").classed('icon-backward', true).on('click', this.empty(glass));
      row.append('td').append('button').classed('btn', true).append('i').attr('id', "" + glass.name + "-full").classed('icon-forward', true).on('click', this.full(glass));
      row.append('td');
      gb = row.append('td').append('button').classed('btn', true).classed('graphbutton', true);
      gb.append('i').attr('id', "" + glass.name + "-showgraph").classed('icon-picture', true).on('click', this.graph(glass));
      if ((_ref = this.config) != null ? _ref.hide_graph : void 0) {
        gb.attr('disabled', 'true');
      }
      gb = row.append('td').append('button').classed('btn', true).classed('graphbutton', true);
      gb.append('i').attr('id', "" + glass.name + "-showchart").classed('icon-signal', true).on('click', this.chart(glass));
      if ((_ref1 = this.config) != null ? _ref1.hide_graph : void 0) {
        gb.attr('disabled', 'true');
      }
      row.append('td').append('button').classed('btn', true).append('i').attr('id', "" + glass.name + "-remove").classed('icon-remove-sign', true).on('click', function() {
    ...
    GlassTable.prototype._create_foot = function() {
      ...
      foot.append('td');
      foot.append('td').append('button').classed('btn', true).append('i').classed('icon-backward', true).on('click', function() {
      ...
      foot.append('td').append('button').classed('btn', true).append('i').classed('icon-forward', true).on('click', function() {
        var glass, _i, _len, _ref, _results;
        _ref = _this.glasses;
        _results = [];
        for (_i = 0, _len = _ref.length; _i < _len; _i++) {
      ...
      foot.append('td');
      foot.append('td');
      foot.append('td').append('button').classed('btn', true).append('i').classed('icon-remove-sign', true).on('click', function() {
        var glass, _i, _len, _ref, _results;
        _ref = _this.glasses;
        _results = [];
        for (_i = 0, _len = _ref.length; _i < _len; _i++) {
...
/*
//@ sourceMappingURL=glass_table.map
*/

},{"../../widgets/glass/glass":2}],5:[function(require,module,exports){
// Generated by CoffeeScript 1.6.3
(function() {
  var Glass, Simulation, WGlass, WGrafter, WHorizontalRuler, WVerticalRuler;
...
},{"../../widgets/glass/glass":2,"../../widgets/glass/wglass":7,"../../widgets/ruler/wvertical_ruler":8,"../../widgets/ruler/whorizontal_ruler":9,"../../widgets/glass/wgrafter":10}],7:[function(require,module,exports){
// Generated by CoffeeScript 1.6.3
/*
*/
...
},{"../widget":11,"./glass":2,"./measure_line":12,"./wmeasure_line":13}],8:[function(require,module,exports){
// Generated by CoffeeScript 1.6.3
/*
(c) 2012, Huub de Beer (H.T.de.Beer@gmail.com)
*/
...
},{"./wruler":14,"../widget":11}],9:[function(require,module,exports){
// Generated by CoffeeScript 1.6.3
/*
(c) 2012, Huub de Beer (H.T.de.Beer@gmail.com)
*/
...
},{"../widget":11}],10:[function(require,module,exports){
// Generated by CoffeeScript 1.6.3
(function() {
...
},{"../widget":11,"./contour_line":15,"../buttons/button":16,"../buttons/action_button":17,"../buttons/switch_button":18,"../buttons/button_group":19}],11:[function(require,module,exports){
// Generated by CoffeeScript 1.6.3
/*
...
},{"../widget":11,"./measure_line":12}],14:[function(require,module,exports){
// Generated by CoffeeScript 1.6.3
/*
(c) 2012, Huub de Beer (H.T.de.Beer@gmail.com)
*/
...
},{"../widget":11}],17:[function(require,module,exports){
// Generated by CoffeeScript 1.6.3
(function() {
...
},{"./button":16}],19:[function(require,module,exports){
// Generated by CoffeeScript 1.6.3
(function() {
...
},{"./option_button":20}],20:[function(require,module,exports){
// Generated by CoffeeScript 1.6.3
(function() {
